...
### layer / model
from keras.layers import Input, Conv2D, concatenate, Dense, Dropout, add, MaxPooling2D, Flatten, BatchNormalization, GlobalAveragePooling2D
...
def D1(input_shape=(height, width, 3)):
    ...
    x6 = Dense(units=64, activation='relu')(x5)
...
def D2(M_shape=(height, width, 3), C_shape=(height, width, 3), W_shape=(w_hei, w_wid, 1)):
    ...
    x5 = Dense(units=214, activation='relu')(x4)
    x6 = Dense(units= 128, activation='relu')(x5)
