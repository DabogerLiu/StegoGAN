...
### layer / model
from keras.layers import Input, Conv2D, concatenate, Dense, Dropout, add, MaxPooling2D, Flatten, GlobalAveragePooling2D
...
def D1(input_shape=(height, width, 3)):
    ...
    #x = conv_block(x, scale, prefix='D_1_1')
    #x1 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x1)
    #x2 = conv_block(x, scale, prefix='D_1_2')
    #x2 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x2)
    #x3 = conv_block(x2, scale, prefix='D_1_3')
...
def D2(M_shape=(height, width, 3), C_shape=(height, width, 3), W_shape=(w_hei, w_wid, 1)):
    ...
    #x = conv_block(x, scale, prefix='D_2_1')
    #x1 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x1)
    #x2 = x = conv_block(x, scale, prefix='D_2_2')
    #x2 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x2)
    #x3 = x = conv_block(x2, scale, prefix='D_2_3')
    #x3 = MaxPooling2D(pool_size=(2,2), strides=(2,2))(x3)
